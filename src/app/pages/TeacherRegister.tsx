...
import { GraduationCap, Lock, User, ArrowRight, Eye, EyeOff, UserPlus } from "lucide-react";
        ...
        <div className="relative z-10 text-white max-w-lg">
          ...
          >
            <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl inline-block mb-6 border border-white/20">
              <UserPlus className="w-12 h-12 text-violet-200" />
            </div>
            <h1 className="text-5xl font-bold mb-6 leading-tight">Join as an <br/>Educator.</h1>
            <p className="text-xl text-violet-100 font-medium leading-relaxed">
              Create your educator account and start managing your classroom with our premium platform today.
            </p>
          </motion.div>
        </div>
      </div>
        ...
        >
          <Card className="w-full bg-white/70 dark:bg-[#111111]/70 backdrop-blur-2xl border-slate-200/60 dark:border-white/10 shadow-2xl dark:shadow-none rounded-3xl overflow-hidden">
            ...
            <CardHeader className="pt-10 pb-6 px-8 text-center">
              <CardTitle className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Educator Registration</CardTitle>
            ...
            <CardContent className="px-8 pb-8">
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-14 text-lg font-medium rounded-2xl bg-violet-600 hover:bg-violet-700 dark:bg-violet-600 dark:hover:bg-violet-500 text-white shadow-xl shadow-violet-500/20 transition-all hover:scale-[1.02] mt-6"
                >
                  {isLoading ? (
